...
//       {/* Hero */}
//       <div className="relative h-64 bg-cover bg-center" style={{ backgroundImage: `url(${disease.image})` }}>
...
//             <span className="bg-blue-100 text-blue-800 text-sm font-semibold px-3 py-1 rounded-full">{disease.category}</span>
//             <span className="bg-red-100 text-red-800 text-sm font-semibold px-3 py-1 rounded-full">{disease.prevalence}</span>
//           </div>
//         </div>
//       </div>
...
//           <section>
//             <h3 className="text-lg font-semibold text-gray-800 mb-1">Symptoms</h3>
...
//           <section>
//             <h3 className="text-lg font-semibold text-gray-800 mb-1">Prevention</h3>
//             <ul className="list-disc list-inside text-gray-700">
...
//           <section>
//             <h3 className="text-lg font-semibold text-gray-800 mb-1">Treatment</h3>
//             <ul className="list-disc list-inside text-gray-700">
...
//           <div className="bg-gray-100 p-4 rounded-lg">
//             <h4 className="text-lg font-bold text-gray-800 mb-2">Affected Regions</h4>
//             <ul className="space-y-2">
//               {affectedAreas.map((area, idx) => {
//                 const areaData = areas.find((a) => a.name === area);
//                 const cases = areaData ? areaData.diseaseCases?.[id] : 0;
...
//           {/* Only show the comment form if the user is authenticated */}
//           {isAuthenticated ? (
//             <div className="bg-white p-6 rounded-lg shadow-md mb-6">
//               <ReviewForm areaId={null} diseaseId={id} />
//             </div>
//           ) : (
//             <div className="bg-yellow-100 p-4 rounded-lg text-center text-gray-700">
//               Please <a href="/login" className="text-blue-600">log in</a> to leave a comment.
//             </div>
//           )}

//           {/* Display existing comments */}
//           <CommentList diseaseId={id} />
//         </div>
//       </div>
//     </div>
//   );
...
function DiseaseDetails() {
  ...
  if (!disease) {
    return (
      <div className="text-center mt-12 text-gray-600">Illness not found.</div>
    );
  }

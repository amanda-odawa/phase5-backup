...
function Home() {
  ...
  const featuredDiseases = diseasesWithAreas.slice(0, 4);
  ...
  return (
    <div className="bg-white text-gray-900">
      ...
      <section className="py-16 bg-gray-50 text-center px-4 sm:px-8">
        ...
        {!loading && !error && featuredDiseases.length === 0 && <p>No diseases found.</p>}
        ...
        <div className="mt-12">
          <Link to="/diseases" className="text-indigo-600 font-medium hover:underline text-lg">
